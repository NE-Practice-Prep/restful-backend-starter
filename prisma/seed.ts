...
async function main() {
  ...
  await prisma.user.upsert({
    ...
    update: {
      ...
      status: UserStatus.active,
      emailVerified: true,
      location: "Rwanda Coding Academy",
    },
    create: {
  ...
  const extinguisherDefs = [
    ...
    {
      serialNumber: "RCA-FE-201",
      location: "Rwanda Coding Academy — Main lab",
      type: ExtinguisherType.CO2,
      size: ExtinguisherSize.Size5lb,
      installationDate: installDate,
      expiryDate,
    ...
    {
      serialNumber: "RCA-FE-202",
      location: "Rwanda Coding Academy — Server room",
      type: ExtinguisherType.CO2,
      size: ExtinguisherSize.Size9lb,
      installationDate: installDate,
      expiryDate: soonExpiry,
    ...
    {
      serialNumber: "RCA-FE-203",
      location: "Rwanda Coding Academy — Cafeteria",
      type: ExtinguisherType.Foam,
      size: ExtinguisherSize.Size12lb,
    ...
    {
      serialNumber: "RCA-FE-204",
      location: "Rwanda Coding Academy — Main entrance",
      type: ExtinguisherType.DryChemical,
      size: ExtinguisherSize.Size5lb,
      installationDate: installDate,
      expiryDate,
